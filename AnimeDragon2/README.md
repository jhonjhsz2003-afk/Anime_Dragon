> Para enviar este ZIP, siga primeiro PUBLICAR-ESTE-PACOTE.md. A pasta raiz de build desta entrega é AnimeDragon2.

# AnimeDragon Studio · v9.4
...
3. Root directory: a pasta que contém `wrangler.toml`. Use `/` se está na raiz do GitHub, ou `AnimeDragon2` para a estrutura deste pacote.
...
Consulte ATUALIZAR-v9.4.md para os controles, publicação e limitações de MKV/HEVC. O player ocupa a janela inteira e usa apenas as fontes reais do provedor.
