...
Consulte docs/ADDONS-v9.6.1.md para funções, configuração e limites. Na verificação de 24/09/2026, Animes BR estava desativado pelo provedor e o endereço genérico do AIO devolvia 404. Ter um manifesto que responde não garante vídeos disponíveis ou compatíveis em todo o acervo.
